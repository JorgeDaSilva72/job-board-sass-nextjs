...
//             <h2 className="text-2xl font-semibold">Job Offer Templates</h2>
...
//             </h2>
//             <p className="text-sm">Structure, call to action, clarity...</p>
//             <Button asChild>
...
//         <Card>
//           <CardContent className="p-6 space-y-4">
//             <h2 className="text-2xl font-semibold">Job Interview Guide</h2>
//             <p className="text-sm">
//               Sample questions, evaluating soft skills, common pitfalls...
//             </p>
//             <Button asChild>
//               <Link href="#">📥 Download the PDF Guide</Link>
//             </Button>
//           </CardContent>
//         </Card>
...
//             <ul className="list-disc list-inside text-sm">
//               <li>Free ATS platforms</li>
//               <li>Video conferencing tools</li>
//               <li>Online technical tests</li>
//             </ul>
//             <Button asChild>
//               <Link href="#">View the Full List</Link>
//             </Button>
//           </CardContent>
//         </Card>
...
//         <Card>
//           <CardContent className="p-6 space-y-4">
//             <h2 className="text-2xl font-semibold">Recruitment Checklist</h2>
//             <p className="text-sm">
//               Define the need, shortlist, interview, onboard...
//             </p>
//             <Button asChild>
...
//         <Card>
//           <CardContent className="p-6 space-y-4">
//             <h2 className="text-2xl font-semibold">Trainings & Webinars</h2>
//             <ul className="list-disc list-inside text-sm">
//               <li>Bias-free Recruitment</li>
//               <li>Successful Onboarding</li>
//               <li>LinkedIn Sourcing</li>
//             </ul>
//             <Button asChild>
//               <Link href="#">🎥 View Trainings</Link>
//             </Button>
//           </CardContent>
//         </Card>
//       </section>
...
//           Our team can help you create job listings or guide you through using
//           our platform.
//         </p>
//         <Button asChild>

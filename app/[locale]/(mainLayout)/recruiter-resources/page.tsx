...
export default function RecruiterResources() {
  const t = useTranslations("RecruiterResources");
  const [searchQuery, setSearchQuery] = useState("");

  const resourceCategories = [
    { id: "all", label: t("categories.all") },
    { id: "templates", label: t("categories.templates") },
  ...
  const resources = [
    {
      id: 1,
      title: t("resources.jobOfferTemplates.title"),
      category: "templates",
      description: t("resources.jobOfferTemplates.description"),
      items: [
        t("resources.jobOfferTemplates.items.developer"),
        t("resources.jobOfferTemplates.items.salesRep"),
        t("resources.jobOfferTemplates.items.hrSpecialist"),
        t("resources.jobOfferTemplates.items.marketing"),
        t("resources.jobOfferTemplates.items.finance"),
      ],
      icon: <FileText className="h-8 w-8 text-blue-500" />,
      link: "#templates",
      linkText: t("resources.jobOfferTemplates.linkText"),
      downloads: "3.2k",
      isNew: false,
      isPopular: true,
    },
    {
      id: 2,
      title: t("resources.jobAdsTips.title"),
      category: "guides",
      description: t("resources.jobAdsTips.description"),
      icon: <BookOpen className="h-8 w-8 text-green-500" />,
      link: "/recruiter-resources/tips",
      linkText: t("resources.jobAdsTips.linkText"),
      downloads: "1.8k",
      isNew: true,
      isPopular: false,
    },
    {
      id: 3,
      title: t("resources.interviewGuide.title"),
      category: "guides",
      description: t("resources.interviewGuide.description"),
      icon: <CheckSquare className="h-8 w-8 text-purple-500" />,
      link: "#interview-guide",
      linkText: t("resources.interviewGuide.linkText"),
      downloads: "4.5k",
      isNew: false,
      isPopular: true,
    },
    {
      id: 4,
      title: t("resources.recommendedTools.title"),
      category: "tools",
      description: t("resources.recommendedTools.description"),
      items: [
        t("resources.recommendedTools.items.ats"),
        t("resources.recommendedTools.items.video"),
        t("resources.recommendedTools.items.tests"),
        t("resources.recommendedTools.items.sourcing"),
      ],
      icon: <PenTool className="h-8 w-8 text-orange-500" />,
      link: "#tools",
      linkText: t("resources.recommendedTools.linkText"),
      downloads: "2.1k",
      isNew: false,
      isPopular: false,
    },
    {
      id: 5,
      title: t("resources.recruitmentChecklist.title"),
      category: "templates",
      description: t("resources.recruitmentChecklist.description"),
      icon: <CheckSquare className="h-8 w-8 text-red-500" />,
      link: "#checklist",
      linkText: t("resources.recruitmentChecklist.linkText"),
      downloads: "3.7k",
      isNew: false,
      isPopular: true,
    },
    {
      id: 6,
      title: t("resources.trainings.title"),
      category: "training",
      description: t("resources.trainings.description"),
      items: [
        t("resources.trainings.items.biasFree"),
        t("resources.trainings.items.onboarding"),
        t("resources.trainings.items.linkedin"),
        t("resources.trainings.items.remote"),
      ],
      icon: <Video className="h-8 w-8 text-blue-500" />,
      link: "#trainings",
      linkText: t("resources.trainings.linkText"),
      downloads: "1.5k",
      isNew: true,
      isPopular: false,
    },
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-10">
      ...
      <section className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="border rounded-lg p-4">
            <h3 className="font-medium text-lg">{t("faq.questions.0.q")}</h3>
            <p className="mt-2">{t("faq.questions.0.a")}</p>
          </div>
          <div className="border rounded-lg p-4">
            <h3 className="font-medium text-lg">{t("faq.questions.1.q")}</h3>
            <p className="mt-2">{t("faq.questions.1.a")}</p>
          </div>
          <div className="border rounded-lg p-4">
            <h3 className="font-medium text-lg">{t("faq.questions.2.q")}</h3>
            <p className="mt-2">{t("faq.questions.2.a")}</p>
          </div>
        </div>
      </section>
      ...
      <div className="p-8 rounded-lg text-center">
        ...
        <p className="mb-6 max-w-2xl mx-auto">{t("contact.description")}</p>
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button asChild>
            <Link href="#contact" className="flex items-center">
              <Phone className="h-4 w-4 mr-2" aria-hidden="true" />
          ...
          <Button variant="outline" asChild>
            <Link href="#suggest">{t("contact.buttons.suggest")}</Link>
          </Button>
        </div>
      </div>
    </div>

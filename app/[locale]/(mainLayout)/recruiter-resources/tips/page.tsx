...
export default function EffectiveJobAds() {
  const t = useTranslations("EffectiveJobAds");
  const [checkedItems, setCheckedItems] = useState<CheckedItemsState>({});
  const toggleChecked = (id: string) => {
    setCheckedItems((prev) => ({
      ...prev,
  ...
  const sections = [
    ...
    { id: "structure", label: t("sections.structure") },
  ...
  const jobTitles = [
    {
      bad: t("jobTitles.bad.codingNinja"),
      good: t("jobTitles.good.seniorFrontend"),
    },
    { bad: t("jobTitles.bad.salesGuru"), good: t("jobTitles.good.salesRep") },
    {
      bad: t("jobTitles.bad.marketingRockstar"),
      good: t("jobTitles.good.digitalMarketing"),
    },
    {
      bad: t("jobTitles.bad.adminSuperstar"),
      good: t("jobTitles.good.officeAdmin"),
    },
  ];
  ...
  const beforeAfter = [
    {
      id: "example1",
      title: t("beforeAfter.example1.title"),
      before: t("beforeAfter.example1.before"),
      after: t("beforeAfter.example1.after"),
    },
    {
      id: "example2",
      title: t("beforeAfter.example2.title"),
      before: t("beforeAfter.example2.before"),
      after: t("beforeAfter.example2.after"),
    },
    {
      id: "example3",
      title: t("beforeAfter.example3.title"),
      before: t("beforeAfter.example3.before"),
      after: t("beforeAfter.example3.after"),
    },
  ];

  const checklist = [
    { id: "c1", text: t("checklist.clearTitle") },
    { id: "c2", text: t("checklist.salaryInfo") },
    { id: "c3", text: t("checklist.qualifications") },
    { id: "c4", text: t("checklist.responsibilities") },
    { id: "c5", text: t("checklist.companyCulture") },
    { id: "c6", text: t("checklist.growthOpportunities") },
    { id: "c7", text: t("checklist.benefits") },
    { id: "c8", text: t("checklist.location") },
    { id: "c9", text: t("checklist.callToAction") },
    { id: "c10", text: t("checklist.proofread") },
  ];

  const languageTips = [
    {
      icon: <Target className="h-6 w-6 text-blue-500" />,
      title: t("languageTips.specific.title"),
      description: t("languageTips.specific.description"),
    },
    {
      icon: <Users className="h-6 w-6 text-blue-500" />,
      title: t("languageTips.inclusive.title"),
      description: t("languageTips.inclusive.description"),
    },
    {
      icon: <Clock className="h-6 w-6 text-blue-500" />,
      title: t("languageTips.results.title"),
      description: t("languageTips.results.description"),
    },
    {
      icon: <BookOpen className="h-6 w-6 text-blue-500" />,
      title: t("languageTips.concise.title"),
      description: t("languageTips.concise.description"),
    },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4 py-6">
        ...
        <p className="text-lg max-w-3xl mx-auto">{t("subtitle")}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-10">
        <Card className="text-center p-4">
          <CardContent className="pt-6">
            <p className="text-4xl font-bold text-blue-600">72%</p>
            <p className="mt-2">{t("stats.jobSeekers")}</p>
          </CardContent>
        </Card>
        <Card className="text-center p-4">
          <CardContent className="pt-6">
            <p className="text-4xl font-bold text-blue-600">30%</p>
            <p className="mt-2">{t("stats.qualifiedApplicants")}</p>
          </CardContent>
        </Card>
        <Card className="text-center p-4">
          <CardContent className="pt-6">
            <p className="text-4xl font-bold text-blue-600">20%</p>
            <p className="mt-2">{t("stats.fewerApplications")}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="basics" className="space-y-8">
        ...
        <TabsContent value="basics" className="space-y-8">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">
              {t("basics.foundationTitle")}
            </h2>

            <div className="p-6 rounded-lg">
              <h3 className="text-xl font-semibold flex items-center mb-4">
                <Lightbulb className="h-5 w-5 text-blue-500 mr-2" />
                {t("basics.whyMatterTitle")}
              </h3>
              <p className="mb-4">{t("basics.whyMatterDescription")}</p>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  <span>{t("basics.benefits.relevantApplicants")}</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  <span>{t("basics.benefits.candidateExperience")}</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  <span>{t("basics.benefits.accurateExpectations")}</span>
                </li>
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  <span>{t("basics.benefits.diversity")}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <h4 className="font-medium text-lg flex items-center">
                    <Target className="h-5 w-5 text-blue-500 mr-2" />
                    {t("basics.elements.clearTitle")}
                  </h4>
                  <p className="mt-2">
                    {t("basics.elements.clearDescription")}
                  </p>
                </div>
                ...
                <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <h4 className="font-medium text-lg flex items-center">
                    <List className="h-5 w-5 text-blue-500 mr-2" />
                    {t("basics.elements.requirementsTitle")}
                  </h4>
                  <p className="mt-2">
                    {t("basics.elements.requirementsDescription")}
                  </p>
                </div>
                ...
                <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <h4 className="font-medium text-lg flex items-center">
                    <CheckCircle className="h-5 w-5 text-blue-500 mr-2" />
                    {t("basics.elements.compensationTitle")}
                  </h4>
                  <p className="mt-2">
                    {t("basics.elements.compensationDescription")}
                  </p>
                </div>
                ...
                <div className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  <h4 className="font-medium text-lg flex items-center">
                    <Bookmark className="h-5 w-5 text-blue-500 mr-2" />
                    {t("basics.elements.cultureTitle")}
                  </h4>
                  <p className="mt-2">
                    {t("basics.elements.cultureDescription")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-lg">
              <h3 className="text-xl font-semibold flex items-center mb-4">
                <AlertCircle className="h-5 w-5 text-amber-500 mr-2" />
                {t("basics.mistakesTitle")}
              </h3>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <AlertCircle className="h-5 w-5 text-amber-500 mr-2 mt-0.5" />
                  <span>{t("basics.mistakes.tooManyRequirements")}</span>
                </li>
                <li className="flex items-start">
                  <AlertCircle className="h-5 w-5 text-amber-500 mr-2 mt-0.5" />
                  <span>{t("basics.mistakes.exclusionaryLanguage")}</span>
                </li>
                <li className="flex items-start">
                  <AlertCircle className="h-5 w-5 text-amber-500 mr-2 mt-0.5" />
                  <span>{t("basics.mistakes.vagueResponsibilities")}</span>
                </li>
                <li className="flex items-start">
                  <AlertCircle className="h-5 w-5 text-amber-500 mr-2 mt-0.5" />
                  <span>{t("basics.mistakes.omittingSalary")}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <TabsContent value="structure" className="space-y-8">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">{t("structure.title")}</h2>
            ...
            <div className="space-y-8 mt-6">
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  1. {t("structure.sections.introduction.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.introduction.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.introduction.example")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  2. {t("structure.sections.company.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.company.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.company.example")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  3. {t("structure.sections.role.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.role.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.role.example")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  4. {t("structure.sections.requirements.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.requirements.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.requirements.example")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  5. {t("structure.sections.benefits.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.benefits.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.benefits.example")}
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-6 pb-2">
                <h3 className="text-xl font-semibold mb-3">
                  6. {t("structure.sections.process.title")}
                </h3>
                <p className="mb-4">
                  {t("structure.sections.process.description")}
                </p>
                <div className="p-4 rounded">
                  <p className="text-sm italic">
                    {t("structure.sections.process.example")}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-lg mt-8">
              <h3 className="text-xl font-semibold mb-4">
                {t("structure.checklistTitle")}
              </h3>
              <p className="mb-4">{t("structure.checklistDescription")}</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {checklist.map((item) => (
                  <div key={item.id} className="flex items-center space-x-2">
                    <Checkbox
        ...
        <TabsContent value="language" className="space-y-8">
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-lg mt-6">
              <h3 className="text-xl font-semibold flex items-center mb-4">
                <Eye className="h-5 w-5 text-amber-500 mr-2" />
                {t("language.biasTitle")}
              </h3>
              <p className="mb-4">{t("language.biasDescription")}</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-medium mb-2">
                    {t("language.masculineWords")}
                  </h4>
                  <ul className="text-sm space-y-1">
                    <li>• {t("language.masculineList.competitive")}</li>
                    <li>• {t("language.masculineList.dominant")}</li>
                    <li>• {t("language.masculineList.aggressive")}</li>
                    <li>• {t("language.masculineList.confident")}</li>
                    <li>• {t("language.masculineList.independent")}</li>
                    <li>• {t("language.masculineList.ambitious")}</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-medium mb-2">
                    {t("language.feminineWords")}
                  </h4>
                  <ul className="text-sm space-y-1">
                    <li>• {t("language.feminineList.supportive")}</li>
                    <li>• {t("language.feminineList.collaborative")}</li>
                    <li>• {t("language.feminineList.committed")}</li>
                    <li>• {t("language.feminineList.dependable")}</li>
                    <li>• {t("language.feminineList.responsible")}</li>
                    <li>• {t("language.feminineList.interpersonal")}</li>
                  </ul>
                </div>
              </div>
              <div className="mt-4">
                <p className="text-sm">{t("language.biasConclusion")}</p>
              </div>
            </div>
            ...
            <div className="mt-8">
              <h3 className="text-xl font-semibold mb-4">
                <MessageSquare className="h-5 w-5 text-blue-500 inline mr-2" />
                {t("language.directCommunicationTitle")}
              </h3>
              <p className="mb-4">
                {t("language.directCommunicationDescription")}
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border rounded p-4">
                  <h4 className="font-medium mb-2">
                    {t("language.companyFocused")}
                  </h4>
                  <p className="text-sm italic">
                    {t("language.companyFocusedExample")}
                  </p>
                </div>
                <div className="border rounded p-4">
                  <h4 className="font-medium mb-2">
                    {t("language.candidateFocused")}
                  </h4>
                  <p className="text-sm italic">
                    {t("language.candidateFocusedExample")}
                  </p>
                </div>
              </div>
            </div>
        ...
        <TabsContent value="examples" className="space-y-8">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold">{t("examples.title")}</h2>
            ...
            <div className="p-6 rounded-lg mt-8">
              <h3 className="text-xl font-semibold mb-4">
                {t("examples.fullExampleTitle")}
              </h3>
              <div className="p-4 rounded border">
                <h4 className="text-lg font-bold mb-3">
                  {t("examples.fullExample.position")}
                </h4>
                <div className="text-sm space-y-4">
                  <p className="font-medium">
                    {t("examples.fullExample.aboutUs")}
                  </p>
                  <p>{t("examples.fullExample.aboutUsText")}</p>

                  <p className="font-medium">
                    {t("examples.fullExample.theRole")}
                  </p>
                  <p>{t("examples.fullExample.theRoleText")}</p>

                  <p className="font-medium">
                    {t("examples.fullExample.whatYoullDo")}
                  </p>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>{t("examples.fullExample.responsibilities.0")}</li>
                    <li>{t("examples.fullExample.responsibilities.1")}</li>
                    <li>{t("examples.fullExample.responsibilities.2")}</li>
                    <li>{t("examples.fullExample.responsibilities.3")}</li>
                    <li>{t("examples.fullExample.responsibilities.4")}</li>
                  </ul>

                  <p className="font-medium">
                    {t("examples.fullExample.requiredQualifications")}
                  </p>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>{t("examples.fullExample.requirements.0")}</li>
                    <li>{t("examples.fullExample.requirements.1")}</li>
                    <li>{t("examples.fullExample.requirements.2")}</li>
                    <li>{t("examples.fullExample.requirements.3")}</li>
                  </ul>

                  <p className="font-medium">
                    {t("examples.fullExample.niceToHave")}
                  </p>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>{t("examples.fullExample.niceToHaveList.0")}</li>
                    <li>{t("examples.fullExample.niceToHaveList.1")}</li>
                    <li>{t("examples.fullExample.niceToHaveList.2")}</li>
                  </ul>

                  <p className="font-medium">
                    {t("examples.fullExample.benefits")}
                  </p>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>{t("examples.fullExample.benefitsList.0")}</li>
                    <li>{t("examples.fullExample.benefitsList.1")}</li>
                    <li>{t("examples.fullExample.benefitsList.2")}</li>
                    <li>{t("examples.fullExample.benefitsList.3")}</li>
                    <li>{t("examples.fullExample.benefitsList.4")}</li>
                    <li>{t("examples.fullExample.benefitsList.5")}</li>
                  </ul>

                  <p className="font-medium">
                    {t("examples.fullExample.commitment")}
                  </p>
                  <p>{t("examples.fullExample.commitmentText")}</p>

                  <p className="font-medium">
                    {t("examples.fullExample.toApply")}
                  </p>
                  <p>{t("examples.fullExample.toApplyText")}</p>
                </div>
              </div>
            </div>
          </div>

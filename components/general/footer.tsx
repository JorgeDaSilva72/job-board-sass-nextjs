...
//             >
//               <Image
//                 src="/footer/logo-topaz-enhance-coupe.jpeg"
//                 alt="Icone"
//                 width={36}
//                 height={36}
//                 className="rounded-lg"
    ...
    <footer id="footer" className="container py-8 sm:py-16">
      <div className="p-10 bg-card border border-secondary rounded-2xl">
        <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8">
          ...
          {/* Contact Section */}
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-lg">{t("sections.contact")}</h3>
            <Link
              href="#footer"
              className="flex items-center gap-2 opacity-60 hover:opacity-100"
            >
          ...
          {/* Platforms Section */}
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-lg">{t("sections.platforms")}</h3>
            <Link
              href="#footer"
              className="flex items-center gap-2 opacity-60 hover:opacity-100"
            >
          ...
          {/* Help Section */}
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-lg">{t("sections.help")}</h3>
            <Link href="#contact" className="opacity-60 hover:opacity-100">
              {t("links.contactUs")}
            </Link>
            <Link href="#faq" className="opacity-60 hover:opacity-100">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="font-bold text-lg">{t("sections.socialMedia")}</h3>
            <Link
              href="https://www.youtube.com/@Afriqueavenir-m5g"
              target="_blank"
              rel="noopener noreferrer"

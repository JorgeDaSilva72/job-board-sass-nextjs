...
// BEGIN 27/04/2025 meilleur placement du LanguageSwitcher
...
//         {/* Toujours visible: LanguageSwitcher et ThemeToggle */}
  ...
  return (
    <header className="border-b mb-4 bg-background/95 backdrop-blur supports-backdrop-blur:bg-background/60 sticky top-0 z-50">
      <nav className="container mx-auto flex justify-between items-center h-16 px-4">
        ...
        <div className="flex items-center gap-3">
          {/* Afficher les toggles seulement en mode desktop pour les utilisateurs non connectés */}
          {!session?.user && (
            <>
          ...
          {session?.user ? (
            <UserDropdown
              ...
              image={session.user.image as string}
              userType={userType}
              showUtilityButtons={true} // Nouveau prop pour indiquer d'afficher les boutons d'utilité
            />
          ) : (
            <>
              <div className="hidden md:flex gap-2">
                ...
                <Sheet>
                  ...
                  <SheetContent>
                    ...
                    <div className="flex flex-col gap-6 mt-8">
                      ...
                      {/* Ajout des boutons utilitaires dans le menu pour mobile */}

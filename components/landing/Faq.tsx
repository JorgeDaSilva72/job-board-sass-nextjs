...
export const FAQSection = () => {
  ...
  const FAQList: FAQProps[] = [
    {
      question: t("questions.jobSearch"),
      answer: t("answers.jobSearch"),
      value: "item-1",
    },
    {
      question: t("questions.careerAdvice"),
      answer: t("answers.careerAdvice"),
      value: "item-2",
    },
    {
      question: t("questions.employerPosting"),
      answer: t("answers.employerPosting"),
      value: "item-3",
    },
    {
      question: t("questions.contactSupport"),
      answer: t("answers.contactSupport"),
      value: "item-4",
    },
  ];
